...
import 'package:lab_clinicas_self_service/src/modules/self_service/search_user/search_user_page.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  List<Bind<Object>> get bindings => [
        Bind.lazySingleton<InformationFormRepository>(
          (i) => InformationFormRepositoryImpl(
            restClient: i(),
          ),
        ),
        Bind.lazySingleton(
  ...
  Map<String, WidgetBuilder> get pages => {
        ...
        '/search-user': (context) => const SearchUserPage(),
